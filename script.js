...
button.addEventListener("click", () => {
    //Get the input text value and trim any white-spaces using in-build trim method of JavaScript
    ...
    //Check if the cleaned text is a palindrome by comparing the original and reverse strings
